...
import heroImage from "../assets/hero.jpg"; // ✅ Importación correcta
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <p className="mt-4 text-lg text-gray-600">
            En <strong>CyberTech IT Essentials</strong> brindamos soluciones
            integrales en soporte técnico, instalación de cámaras, redes,
            mantenimiento de PC y ciberseguridad. Atención a hogares y Pymes con
            servicio presencial y remoto.
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-500">
                  Protegemos tus datos y dispositivos.
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-500">
                  Wi-Fi estable y configuración segura.
                </div>
              </div>
            </div>
          </div>
