...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 antialiased relative">
      ...
      <div className="fixed bottom-6 right-6 group z-50 flex flex-col items-end">
        {/* Tooltip */}
        <div
          key={index}
          className={`mb-2 px-3 py-2 bg-gray-800 text-white text-sm rounded-lg shadow-lg whitespace-nowrap transition-all duration-500 ease-out ${
            isMobile
              ? "opacity-100 translate-y-0" // siempre visible en móviles
        ...
        {/* Botón */}
        <a
          href="https://wa.me/56945409091" // Cambia por tu número
          target="_blank"
